...
const Body: NextPage = () => {
  return (
    <div className="w-full relative flex flex-col items-start justify-start pt-0 px-0 pb-[30.5px] box-border leading-[normal] tracking-[normal] text-center text-[34px] text-white font-montserrat">
      <Nav />
      <div className="self-stretch bg-darkkhaki overflow-hidden flex flex-col items-start justify-start pt-[434px] pb-[404px] pl-[559px] pr-[558px] box-border gap-0.5 max-w-full mq750:pt-[183px] mq750:px-[139px] mq750:pb-[171px] mq750:box-border mq1050:pt-[282px] mq1050:px-[279px] mq1050:pb-[263px] mq1050:box-border">
        <div className="self-stretch flex flex-row items-start justify-start py-0 pl-[99px] pr-[98px] box-border max-w-full mq450:pl-5 mq450:pr-5 mq450:box-border mq1050:pl-[49px] mq1050:pr-[49px] mq1050:box-border">
      ...
      <main className="self-stretch bg-black flex flex-col items-end justify-start pt-[510px] pb-[306px] pl-[572px] pr-[786px] box-border relative gap-[227px] max-w-full text-left text-27xl text-white font-montserrat lg:pt-[215px] lg:pb-[129px] lg:box-border mq750:gap-[57px] mq750:pt-[140px] mq750:pb-[84px] mq750:pl-[143px] mq750:pr-[196px] mq750:box-border mq1050:gap-[113px] mq1050:pl-[286px] mq1050:pr-[393px] mq1050:box-border">
        <div className="self-stretch flex flex-col items-end justify-start gap-[187px] max-w-full text-45xl mq450:gap-[47px] mq750:gap-[93px]">
          <div className="self-stretch flex flex-col items-start justify-start">
            <h2 className="m-0 self-stretch h-[267px] relative text-inherit leading-[64px] font-black font-[inherit] flex items-center shrink-0 mq450:text-19xl mq450:leading-[38px] mq1050:text-32xl mq1050:leading-[51px]">
              <span>
        ...
        <b className="w-[466px] absolute !m-[0] bottom-[270px] left-[616px] text-17xl [text-decoration:underline] leading-[18px] flex items-center whitespace-nowrap mq450:text-3xl mq450:leading-[11px] mq1050:text-10xl mq1050:leading-[14px]">
          aaltismann@gmail.com
        </b>
        <div className="w-[440px] flex flex-row items-start justify-end pt-0 px-11 pb-[55px] box-border max-w-full text-center mq450:pl-5 mq450:pr-5 mq450:pb-9 mq450:box-border">
        ...
        <div className="w-[518px] flex flex-row items-start justify-end py-0 px-[70px] box-border max-w-full text-right mq750:pl-[35px] mq750:pr-[35px] mq750:box-border">
          <div className="flex-1 flex flex-col items-start justify-start gap-3.5 max-w-full">
            <div className="self-stretch h-[63px] relative leading-[36px] font-black flex items-center shrink-0 mq450:text-9xl mq450:leading-[22px] mq1050:text-18xl mq1050:leading-[29px]">
              Kontakt
            </div>
        ...
        <section className="h-[560px] absolute !m-[0] top-[-83px] left-[calc(50%_-_956.5px)] text-45xl leading-[60px] uppercase font-black font-montserrat text-white text-left flex items-center mq450:text-19xl mq450:leading-[36px] mq1050:text-32xl mq1050:leading-[48px]">
