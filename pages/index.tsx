...
const Body: NextPage = () => {
  ...
  <Nav />
  <div className="flex absolute z-30 text-[90px] uppercase font-montserrat text-white text-opacity-80 font-black mq450:text-[24px] mt-40 mq750:text-[36px] mq450:leading-[24px] mq750:leading-[36px]" >
  ...
  <video
    ...
    loop
    muted
    className="w-full relative z-10 min-h-30% max-w-full"
  >
    <source
    ...
    Your browser does not support the video tag.
      ...
      <main className="w-full flex flex-col items-center justify-center box-border relative max-w-full text-left text-27xl text-white font-montserrat ">
      <section className="w-full leading-[60px] uppercase font-black font-montserrat text-white items-center mq450:text-[24px] mq750:text-[36px] mq450:leading-[24px] mq750:leading-[36px]">
        ...
        <div className="w-full flex flex-col items-center justify-center mt-[85px] ">
          ...
          <div className="flex flex-col mt-[75px] max-w-full">
            <div className="max-w-full">
              <h2 className="flex flex-col relative text-[74px] break-all leading-[74px] lowercase font-black items-center justify-center ">
                Mitt hobby projekt:
              </h2>
              ...
              <a
          className="relative [text-decoration:underline] mt-[-65px] text-[74px] font-black break-all leading-[74px] text-pink-400 "
        ...
        <div className="w-[440px] flex flex-row items-start justify-center mt-[300px] box-border max-w-full text-center ">
          <div className="h-[336px] relative leading-[48px] font-black flex break-all items-center ">
        ...
        <div className="w-full flex flex-col items-center justify-center mt-[300px] box-border max-w-full text-center pb-[200px]">
